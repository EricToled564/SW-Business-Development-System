...
| 9b | [**Mapa del Funnel · fuentes y accesos**](#funnel) | **Documento canónico de medición.** Los tres canales de entrada y sus cortes, las etapas de la espina de conversión con su definición operativa (cuándo cuenta cada una), la fuente exacta de cada dato, el responsable de otorgar cada acceso, las llaves de unión, y los tres accesos que hoy faltan pedir en el Anexo Uno. | Dirección, Sistemas, Marketing |
| 10 | [**Seguridad del sistema**](#seguridad) | Protección de datos personales en los cuatro canales de captación y en la base de datos del funnel: minimización, no retención y custodia dentro de la infraestructura de Sports World. | TI, Legal, negocio |
| 10a | [**Estrategia de Retención Cero (ZDR)**](#zdr) | Cómo se garantiza que los datos personales de los prospectos residan de forma permanente únicamente en el CRM de Sports World: retención cero por arquitectura en la capa propia, convenio de retención cero con el proveedor del modelo, modo de retención cero de la plataforma de voz (acceso únicamente por API), **correo saliente por el servicio de correo de Sports World**, regla de selección vinculante para todo componente de IA, y el régimen de la **base de conocimiento de BES** —que no contiene datos personales— con las categorías que no deben existir en ella y su autorización expresa. | TI, Legal, Dirección |
