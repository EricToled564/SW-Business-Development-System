...
| 10a | [**Estrategia de Retención Cero (ZDR)**](#zdr) | Cómo se garantiza que los datos personales de los prospectos residan de forma permanente únicamente en el CRM de Sports World: retención cero por arquitectura en la capa propia, convenio de retención cero con el proveedor del modelo, modo de retención cero de la plataforma de voz (acceso únicamente por API) y regla de selección vinculante para todo componente de IA. | TI, Legal, Dirección |
