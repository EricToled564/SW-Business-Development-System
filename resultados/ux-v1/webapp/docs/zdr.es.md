...
Este documento fija la estrategia de **retención cero de datos personales** del sistema —**ZDR**, por *Zero Data Retention*— y especifica cómo se aplica en cada componente: la página, el agente **BES** y las plataformas de inteligencia artificial que lo impulsan. El compromiso es uno y es verificable: **ningún componente del sistema, propio o de proveedor, conserva datos personales de los prospectos en reposo; el único registro permanente es el CRM de Sports World.**
