...
|---|---|---|
| **A — Rediseño Web** (Sección A) | USD $81,000.00 sin IVA (MXN $1,441,800.00), único + iguala mensual de $43,000 MXN (USD $2,415.73), Opción A elegida | Desde la firma de este Contrato |
...
Conforme a la **Opción A elegida**, la iguala mensual es de **$43,000 MXN (USD $2,415.73 al tipo de cambio contractual de $17.80); $49,880 MXN con IVA** y EL CLIENTE administra sus propios contenidos en el CMS; el soporte, el mantenimiento y la bolsa de 8 horas se prestan por igual. *Recomposición de la iguala:* del cálculo original de $35,000 MXN se **descuenta el componente de hospedaje** ($2,670 MXN; USD $150), que ahora corre en la infraestructura proporcionada por EL CLIENTE, y se **incorpora el costo de la bolsa de mejora de 8 horas mensuales** (8 × $1,335 MXN/hora, USD $75/hora = $10,680 MXN), no considerada en el cálculo original: $35,000 − $2,670 + $10,680 = $43,010, redondeado a **$43,000 MXN**. La Opción B conserva su precio de referencia original; de elegirse, se recompondría bajo el mismo criterio. La Contraprestación es fija e incluye el valor de todos los Servicios y de los servicios relacionados necesarios para cumplir el objeto, sin ajustes salvo servicios adicionales pactados por escrito.
