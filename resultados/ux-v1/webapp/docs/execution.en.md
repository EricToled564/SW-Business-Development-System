...
**Guiding principle.** The 8-week count runs from the delivery of 100% of the requirements of **Blocks 0 and A** of Annex One (Blocks B through F are enforceable milestones on their own dates); delays attributable to Sports World extend the timeline day for day (and trigger the stand-by of Clause Fifteen). For this reason the plan **front-loads** all dependencies to Week 1.
...
- **Core assumption:** Sports World **exposes its standard CRM API and the catalog data** (club status, coordinates, amenities, classes, schedules, rates, discounts/promotions) of Annex One; the custom integration is resolved by the **PROVIDER's middleware**. The 8-week count runs from the delivery of 100% of the requirements of Blocks 0 and A of Annex One.
