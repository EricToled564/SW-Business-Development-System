...
Los cuatro modos del selector de club van con nombre en español y sin código: **varios cumplen · uno cumple · cumple más lejos · lo más cercano a tu objetivo**. Los tres estados del menú también van con nombre: **sin cuestionario · con experiencia · con visita** (D-89).
...
|---|---|---|---|
| **1** | Vamos a crear el mejor sistema de captación y conversión digital de fitness en México | `01-vamos-a-crear-el-mejor-sistema.es.md` | Escrito por Eric |
| **2** | Cómo se pierde hoy a quien ya decidió entrar a un gimnasio | `02-como-se-pierde-hoy.es.md` | Escrito por Eric |
| **3** | El sitio: cómo la persona llega y cómo se le guía | `03-el-sitio-como-llega-y-como-se-le-guia.es.md` | Escrito, pendiente de aprobación |
| **4** | Qué recibe la persona y qué recibe el asesor | `04-que-recibe-la-persona-y-que-recibe-el-asesor.es.md` | Aprobado |
| **5** | El cuestionario: el único instrumento | `05-el-cuestionario.es.md` | Aprobado |
| **6** | Quién puede recorrer la experiencia | `06-quien-puede-recorrer-la-experiencia.es.md` | Aprobado |
...
| **16** | El traspaso al club | — | Pendiente |
| **17** | El panel de actualización sin código | — | Pendiente |
| **18** | **Qué hace el sistema cuando algo sale mal** | — | **Pendiente. Capítulo nuevo** |
| **19** | **Los umbrales** | — | **Pendiente. Capítulo nuevo** |
| **20** | **Criterios de aceptación** | — | **Pendiente. Capítulo nuevo** |

### Subcapítulos previstos de los que faltan
...
| **16** | Qué recibe el club · Qué recibe el asesor · **Las llamadas directas: quien contestó y no agendó** · Qué ocurre si la persona no se presenta · **Qué ve el asesor cuando el prospecto ya existía** |
| **17** | Qué se puede cambiar sin programar · Quién lo autoriza · Qué queda registrado |
| **18** | La tabla de casos: qué lo dispara, qué ve la persona y qué queda registrado · Cuando una fuente no llega · Cuando el servidor falla · Cuando el texto viene fuera de rango · Cuando la conexión es lenta · Cuando el guion de la capa personal no corre · Cuando la sesión se pierde a medio recorrido |
| **19** | Velocidad de aparición y de respuesta · Estabilidad de la página mientras carga · Accesibilidad, con los cuatro pilares · Rastreo de las 49 páginas de club · **Cómo se comprueba cada cifra y con qué herramienta** |
| **20** | Una condición comprobable por capítulo · Con qué se comprueba cada una · Qué se considera entregado |

---

## Los seis anexos

| Anexo | Qué contiene | Estado |
|---|---|---|
| **A** | Trazabilidad: los 62 cambios del pliego de correcciones y dónde quedó cada uno | Pendiente |
| **B** | Decisiones aplicadas, una por una | Pendiente, se arma desde `decisiones.es.md` |
...
El inventario va a anexo, y no al capítulo 3, porque es una lista larga y ponerla a media lectura rompe el hilo. **El capítulo 3 lleva la lógica; el anexo lleva el detalle.**

**Los umbrales no van a anexo, van al capítulo 19.** Una cifra que hay que cumplir y un criterio de aceptación son la misma cosa —una condición que se comprueba—, y separarlas obligaría a leer dos piezas para saber si el trabajo está entregado.

---

## Qué queda fuera de este documento

| Pieza | Por qué | Dónde vive |
|---|---|---|
...
|---|---|---|
| `insumo-entrenamiento-acuatico.es.md` | Capítulo 11, apartado de entrenamiento aeróbico en alberca, y la página de esa modalidad | Propuesta, sujeta a validación del profesional de salud que Sports World designe |

---

## El instrumento que rige

**CEI-01 versión 1.4**, que vive en esta misma carpeta como `CEI-01-v1.4.es.html` y su PDF. El cuestionario del Anexo A del Manual del Proceso Comercial es una versión anterior y no se usa.
