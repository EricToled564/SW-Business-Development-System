...
| **Cuándo se produce el brief** | **Choca con D-100.** La tabla del apartado 4.1, en la versión de Eric del 21 de septiembre, declara que el asesor recibe el brief «**una vez agendada la visita** y antes de que la persona llegue al club». D-100 y el apartado 8.5.2 establecen lo contrario para un caso: **quien contesta el cuestionario y no agenda también produce brief**, marcado como **llamada directa**, al club que el sistema le resolvió. D-100 lo dice de forma expresa: «Corrige el apartado 8.5.2, que enviaba brief solo cuando había cita». Las dos redacciones no pueden convivir. **Lo resuelve Eric**, en una de dos direcciones: acotar la celda de 4.1 para que cubra los dos casos, o retirar la llamada directa, que obligaría a revisar D-100, el apartado 8.5.2 y el capítulo 16 |
