# Capítulo 2 · Qué recibe la persona y qué recibe el asesor
...
## 2.1 Un solo cálculo, dos entregas
...
Que las dos digan lo mismo no depende de que alguien las mantenga alineadas: **salen del mismo cálculo y del mismo texto.** El capítulo 11 especifica cómo se produce ese texto y qué ocurre si la redacción automática falla.
...
## 2.2 Lo que ve la persona

### 2.2.1 Página 1 · Quién eres y dónde vas a entrenar
...
### 2.2.2 Página 2 · Tu combinación recomendada

Responde la segunda pregunta: qué voy a hacer ahí.

| Elemento | Qué contiene |
|---|---|
| Los tres bloques | Bloque 01, Bloque 02 y Bloque 03, cada uno con su contenido y su razón |
| Cambiar clases | Panel que se abre a petición, con las otras clases idóneas y el catálogo del club en modo consulta |
| Sección de seguridad | El texto que corresponde a lo que la persona declaró |
| Argumento de infraestructura | Qué pone la red de 49 clubes detrás de ese plan |
| Cierre | Botón de avance y opción de reiniciar |

### 2.2.3 El plan se recompone cuando ella cambia algo

La experiencia no es una tarjeta fija. **Cuando la persona cambia de club o cambia de clases, el plan se vuelve a calcular completo** contra el catálogo del club que quedó: los tres bloques, las clases, la modalidad, el tiempo de traslado. El capítulo 9 especifica qué se recalcula y en qué orden.
...
### 2.2.4 Las banderas existen para elegir, y desaparecen al elegir
...
### 2.2.5 Lo que nunca aparece en su experiencia
...
## 2.3 BES, disponible en todo momento
...
BES hace lo mismo que la pantalla permite —cambiar de club, cambiar de clases— y nada más. El capítulo 6 especifica el mecanismo completo.

## 2.4 Lo que lee el asesor: el brief
...
### 2.4.1 Página 1 · Quién viene y cómo contactarla
...
| Bloque | Qué contiene |
|---|---|
| Confirmación de la cita | Club, dirección, fecha y hora. Es lo que la persona conserva |
...
### 2.4.2 Página 2 · Cómo se conduce la visita

| Bloque | Qué contiene |
|---|---|
| §3 · Qué validar | Cinco preguntas para confirmar en persona lo que declaró en pantalla |
| §4 · Ruta recomendada | Cuatro pasos, en orden, para el recorrido del club |
| §5 · Propuesta recomendada | La oferta principal y su complemento |
| §6 · Prioridades de cierre | Tres puntos, en orden de peso |
| §7 · Notas y señales | Las señales que el sistema levantó del cuestionario |
| Guion de cierre | Lo que el asesor puede decir, redactado en primera persona |
| Registro del asesor | Cuatro cajas vacías que el asesor llena durante la visita |
| Pie | La leyenda de uso interno |

### 2.4.3 Las señales del brief
...
Ninguna señal contiene información de salud. El cuestionario no la recaba, y el capítulo 3 explica por qué.

### 2.4.4 Cuando otro club entrega mejor la experiencia
...
Donde la persona avanza sola —el sitio y WhatsApp— no hay nadie que module esa información, y por eso rige la regla del apartado 2.2.4: las banderas viven mientras elige y desaparecen al elegir. Donde hay asesor —la consola, con la persona sentada al lado y una sola pantalla—, decide el asesor.

## 2.5 Por qué el club va primero
...
El resto del orden se desprende de lo mismo: primero dónde, después qué, y al final con qué respaldo.
