...
| `decisiones.es.md` | 13,662 | `8f688827cb6933ba7d93bbc2ee5e2e014bfbaa3adf5e4d3de5f2bf55f74d30a0` |
...
| **D-106, y una remisión rota que el instalar el capítulo 8 dejó** | El capítulo 9 apuntaba a «el apartado 8.5.3» para los recordatorios de la visita; con el capítulo 8 de Eric, 8.5.3 pasó a ser otra cosa y los recordatorios se movieron a 8.5.6. `remisiones.py` no lo detectó, porque 8.5.3 sigue existiendo —solo que ya no dice lo que la cita esperaba. Es exactamente el caso que ya advertía la Norma: verificar que el destino existe no es verificar que sea el correcto. Corregida a mano. **D-106** cierra el punto abierto «cuándo se entrega el brief»: generar ocurre al terminar el cuestionario (4.1); escribir y enviar ocurre al cerrar la sesión (8.5.2). El cierre de sesión nunca dispara el cálculo, solo la escritura de lo ya calculado |
