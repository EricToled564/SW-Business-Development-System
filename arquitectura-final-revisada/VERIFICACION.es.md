...
| `00-paginas-iniciales.es.md` | 2,699 | `05e2c43e97acae2e58d8b2c5d5c3fa3cac6573b8a5c58d041062d64a9e23162f` |
...
| **9** | Sí | **Eric.** Instalado carácter por carácter, sustituye por completo la versión anterior | Entra **`sw_person_id`**, cuarto identificador junto a `web_session_id`, `session_uuid` y la **llave de reconocimiento** —que renombra a «llave canónica» en todo el documento—. Glosario actualizado con las dos entradas; la remisión de 8.5.3 en el capítulo 8 corregida al nuevo nombre. Modelo de datos en cuatro registros separados: prospecto, sesión, citas y Experiencias Ideales. Tres frases a resolución de Eric |
