...
| `02-el-sitio-como-llega-y-como-se-le-guia.es.md` | 6,099 | `cb1ddbbdb0a9a54f6b022779e48fd11ee6fbf90ff1db4fa8fefb3270409a22c6` |
...
| `README.es.md` | 355 | `375ef775372337b4d017637e442b2ff269e405066d664d47898d0fa0a0a97940` |
| `decisiones.es.md` | 8,623 | `b6a7b37b234273401cd73073f18573c386cec5acb358401d79976f7d3024a485` |
...
| **La ranura del objetivo** | **D-73.** Nombra el objetivo: «Conoce las clases ideales para [nombre]». En una página de objetivo, el de la página; fuera de ella, el que la persona declaró. Con dos objetivos, el principal; el menú se evalúa sobre cuatro variables |
