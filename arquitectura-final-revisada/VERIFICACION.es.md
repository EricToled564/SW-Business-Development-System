...
| `08-el-recorrido-en-pantalla.es.md` | 4,170 | `9f7be8645ad4678d3f713bda0d87dfc78a27a10f9b5e4bcde606458c218f3c06` |
...
| **8** | Sí | **Eric.** Instalado carácter por carácter, sustituye mi corrección del 21 de septiembre | Entra el mecanismo de **ventana de contexto**: cada cita agendada cierra la ventana de navegación que la produjo, y lo visitado después alimenta la siguiente intención de agenda (8.3.5, 8.3.5.1, 8.3.5.2, nuevos). El brief deja de depender de la cita, en la misma dirección que la tercera versión del capítulo 4. Dos frases a resolución de Eric |
