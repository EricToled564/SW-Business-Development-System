...
| `08-el-recorrido-en-pantalla.es.md` | 4,201 | `d10ed5766c89344eb0016219ef05700bb565c100e577ced3b8841224f96a8cdc` |
| `09-datos-de-contacto-y-consentimiento.es.md` | 1,571 | `274a133722bebeb3f547b6a42b1eb798a67e8ae08dba2b2ba1b340cdea680622` |
...
| **9** | **No** | Versión anterior | La conciliación con la llave canónica y el reencuentro (D-56). El 21 de septiembre: el nombre viene de **Q1**. **El 22:** la remisión a los recordatorios apuntaba a 8.5.3, que con el capítulo 8 de Eric pasó a ser «Las dos llaves de sesión»; corregida a **8.5.6**, donde viven ahora |
