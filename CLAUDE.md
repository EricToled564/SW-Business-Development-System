...
**La revisión documental se opera sobre Fast.io**, contra los documentos cargados en el workspace, y no contra copias dentro del depósito. El depósito no aloja registros de revisión, copias de trabajo ni páginas espejo: si hace falta revisar un documento, se revisa el documento.
...
- Rama de trabajo: `claude/adoring-thompson-6a7sxx`. Publicado en https://erictoled564.github.io/SW-Business-Development-System/

## Estado de las contradicciones

Las contradicciones cerradas ya no se llevan en lista: cada una tiene una regla que la sostiene en `tools/consistencia.js` (corre en CI). Si algo vuelve a aparecer, lo detecta el programa, no la memoria.
...
Los PDFs del depósito ya reflejan el texto vigente: el Contrato como V4.3 (39 págs) y los dos addenda regenerados.
